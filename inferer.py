...
checking - for every patient-specific gene (mutation or DE) that does NOT appear
...
# IDs of patients to examine (as it is on files used above)
PATIENTS = ["TCGA-AB-2806-03"]
...
# Directory to write drug target candidate for each patient
...
for i in range(len(PATIENTS)):
    ...
    # Loading DE genes for future b2h computation
