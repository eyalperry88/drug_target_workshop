...
# patients = ["TCGA-AB-2803-03", "TCGA-AB-2805-03", "TCGA-AB-2806-03", "TCGA-AB-2807-03", "TCGA-AB-2810-03", "TCGA-AB-2811-03", "TCGA-AB-2812-03", "TCGA-AB-2813-03", "TCGA-AB-2814-03", "TCGA-AB-2815-03", "TCGA-AB-2816-03", "TCGA-AB-2817-03", "TCGA-AB-2818-03", "TCGA-AB-2819-03", "TCGA-AB-2820-03", "TCGA-AB-2821-03", "TCGA-AB-2823-03", "TCGA-AB-2824-03"]
g = DTWGraph()
print('Loading PPI...')
...
threshold = 5
for mut in mutation_count:
    if mutation_count[mut] >= threshold:
        g.nodes[mut].mutation_type = 'Y'
for de in de_genes:
    if de_count[de] >= threshold:
        causal_genes.append(de)
...
causal_genes = list(set(causal_genes))
print('causal genes size: ', len(causal_genes))
