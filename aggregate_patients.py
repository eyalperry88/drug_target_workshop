...
for patient in patients:
    try:
        f = open('output_ex/' + patient + '_diff.txt', 'r')
        for line in f:
        ...
        f.close()
        """
        f = open('output_cv_1/' + patient + '_b2h.txt', 'r')
        for line in f:
            row_data = line.strip().split('\t')
            gene = row_data[0]
...
f = open('output_ex/total_diff.txt', 'w')
sorted_genes = []
...
sorted_genes = []
f = open('output_cv_1/total_b2h.txt', 'w')
